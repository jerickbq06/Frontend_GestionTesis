...
const Page = () => {
    ...
    const fetchPropuestas = async () => {
      const response = await fetch(`${dataConfig.API_URL}/propuesta_tesis`, {
        ...
        headers: {
          ...
          Authorization: `Bearer ${localStorage.getItem("decanoToken")}`,
        },
      });
  ...
  const logout = () => {
    ...
    localStorage.removeItem("decanoToken");
          ...
          <table className="w-full border border-red-300 h-auto overflow-auto">
            <thead>
              <tr className="bg-red-400 text-white">
                ...
                <th className="p-3">Estado de tema</th>
              ...
              {estudiantes.length > 0 ? (
                estudiantes.map((estudiante) => (
                  <tr key={estudiante.id_usuario}>
                    ...
                    <td className="p-3 text-center">
                      {estudiante.tesis.length === 0 ? "En espera" : "Aprovado"}
                    </td>
                    <td className="p-3 text-center">
